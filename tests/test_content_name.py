...
from .utils import render_template, render_template_with_context
...
@pytest.mark.django_db
def test_allows_context_variables_as_content_names_from_complex(simple_content):
    t = "{% tinycontent content_name %}Text if empty.{% endtinycontent %}"
...
@pytest.mark.django_db
def test_allows_multiple_arguments_and_variables_from_complex(split_content):
    t = "{% tinycontent 'foo' key %}Text if empty.{% endtinycontent %}"
...
@pytest.mark.django_db
def test_allows_unprovided_ctx_variables_as_content_name_complex(simple_content):
    t = "{% tinycontent content_name %}Text if empty.{% endtinycontent %}"
...
@pytest.mark.django_db
def test_allows_unprovided_ctx_variables_as_content_name_simple(simple_content):
    t = "{% tinycontent_simple content_name %}"
