...
def test_alternate_text_if_not_found(simple_content):
    t = "{% tinycontent 'neverexists' %}I could not find it.{% endtinycontent %}"
...
def test_alternate_text_if_found(simple_content):
    t = "{% tinycontent 'foobar' %}I could not find it.{% endtinycontent %}"
...
def test_alternate_text_if_not_found_with_embedded_tags(simple_content):
    ...
    assert "I could not find 42." == render_template_with_context(t, ctx)
